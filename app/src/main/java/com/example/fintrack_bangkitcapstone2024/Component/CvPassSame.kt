...
class CvPassSame @JvmOverloads constructor(
    ...
    private fun validatePasswordSame() {
        val parentView = parent as? ViewGroup
        val passwordEditText = parentView?.findViewById<AppCompatEditText>(R.id.cv_pass_register)
